...
governed_instruction_set = {
  "interpretation": {
    ...
    "context_gaps": [
      "No explicit description of the Bella agent’s concrete domain (e.g., legal analysis, security operations, research orchestration), only that it is a ‘strategic assistant’.",
